...
**11. Johor alone trails Singapore, but Malaysia nationally has already pulled ahead.** Johor's 850MW built capacity is smaller than Singapore's ~1.4GW operational base, but this project's own earlier framing understated Malaysia's real position by using Johor as a stand-in for the whole country: Malaysia's national total, an estimated 2,055MW by end-2026, already exceeds Singapore's, once the major hyperscale construction happening in Selangor and Negeri Sembilan (Notebook 6) is counted too (Notebook 11).
...
A genuine framing gap was also found and corrected: this project's own Notebooks 1, 2, 7, and 10 focus heavily on Johor, and Notebook 11 originally compared Johor's own capacity directly against Singapore's without flagging that Johor is not the whole country. This project's own Notebook 6 contractor data shows major hyperscale construction happening in Selangor and Negeri Sembilan too, together accounting for roughly two-thirds of the confirmed contractor-dollar value found. Using Johor alone to represent Malaysia in the regional comparison understated the country's actual position: Malaysia's national capacity (an estimated 2,055 MW by end-2026) already exceeds Singapore's, even though Johor specifically does not. Notebook 11 and Notebook 1 were both updated to state this plainly rather than leave the original, narrower framing standing.
