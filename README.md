...
<img src="./outputs/figures/12_synthesis.png" width="800" alt="Chart showing which layers of the data centre value chain have the most verifiably realised value capture today: landowners and YTL Power's segment profit at the top, hyperscaler pledges at the bottom">
...
**Treat Malaysia's AI data centre boom as a genuine, fast-scaling economic activity that is still meaningfully ahead of its own realised demand, unevenly distributed in who actually benefits from it today, and only partly reassured by government restraint that does not directly touch the boom's own AI-linked core.** TNB's own disclosures show 8.35GW secured but only 1.26GW actually drawn (15% of secured, 22% of connected capacity, Notebook 3); a previously unannounced government policy has quietly filtered new non-AI applications for roughly two years (Notebook 3), real evidence of institutional restraint, but not proof the AI-linked pipeline behind the utilisation gap is itself curated, since that category was explicitly exempted from the filter.

What that means depends on who is asking:

**If you are an investor** evaluating exposure to this theme, weight audited, realised-value layers, YTL Power's real segment profit (Notebook 5), landowners' already-quantified gains (Notebook 7), more heavily than the widely-quoted hyperscaler pledge totals (Notebook 8), which remain fundamentally unverifiable with public information regardless of how large they sound. Note that YTL Power's data centre segment is still a small share of the company (3.9% of revenue, Notebook 5), so buying YTL Power for data centre exposure also buys its currently-struggling Power Generation business; there is no pure-play listed vehicle for this theme yet. Keppel Ltd's comparable segment (Notebook 5) suggests YTL Power is not obviously mispriced against a real regional peer, for whatever that comparison is worth given the scope caveats already noted there.

**If you are a contractor** deciding whether to bid on more data centre work, price it as ordinary, solid construction work, not a premium category: none of the three contractors examined shows a distinctly higher margin on data centre jobs than on their normal business (Notebook 6). Concentration risk is real and uneven: Sunway Construction's data centre exposure is a large share of its whole business, while Gamuda's is a small slice of a much larger, diversified book, a materially different risk profile worth weighing before deciding how much of a single order book to put into this one category. Selangor and Negeri Sembilan are just as real a market as Johor (Notebook 2); bidding effort concentrated only on the Johor corridor would miss roughly two-thirds of the confirmed activity this project found.

**If you are a policymaker or regulator**, two of this project's findings look like genuinely exportable models rather than one-off fixes: the informal application filter that lets AI-linked projects through while blocking speculative non-AI ones (Notebook 3), and Johor's targeted response to the water constraint, banning the least efficient facility tier rather than imposing a blanket freeze (Notebook 10). Both manage growth without halting it, and neither was loudly announced, worth considering whether making the criteria explicit and public would improve investor certainty without losing the flexibility that made them work. The Gelang Patah protest (Notebook 10) points at a real gap this project's evidence cannot resolve: whether current siting and community-consultation requirements are adequate near residential areas, a genuinely open question for regulators, not something this project's public sources can answer.
...
**13. The government's own electricity forecast was already outpaced within two months of being given to parliament.** A written answer on 6 July 2026 put data centres at 7% of Peninsular Malaysia's electricity demand; by early September 2026, independent reporting citing TNB put the actual share at 9.28%, the same measurement, not a different one, showing real growth outrunning the government's own recent planning assumptions (Notebooks 4, 11).

**14. Water policy differs sharply by state, and Johor's crisis is not the regional norm.** Johor intervened reactively after real strain (a facility-tier ban, a 2027 wait for new capacity); Selangor instead requires confirmed water and power sufficiency before approving a new data centre at all, and its water utility currently holds a real reserve margin, not a crisis; Negeri Sembilan's approach is different again, with one developer building its own dedicated water treatment plant rather than drawing on the public network (Notebook 10).
...
| [07: The Land Story](./notebooks/07_land_story.ipynb) | Who is capturing value at the ground level, across Johor, Selangor, and Negeri Sembilan? | PUBLIC |
...
| [10: The Water Constraint](./notebooks/10_water_constraint.ipynb) | How real is the water constraint, and is Johor's story the same everywhere? | PUBLIC |
| [11: Regional Competitive Position](./notebooks/11_regional_position.ipynb) | Is Johor a fair stand-in for Malaysia's regional position, and is the grid showing strain? | PUBLIC |
...
A genuine framing gap was also found and corrected: this project's own Notebooks 1, 2, 7, and 10 focus heavily on Johor, and Notebook 11 originally compared Johor's own capacity directly against Singapore's without flagging that Johor is not the whole country. This project's own Notebook 6 contractor data shows major hyperscale construction happening in Selangor and Negeri Sembilan too, together accounting for roughly two-thirds of the confirmed contractor-dollar value found, and Johor's built capacity is only 41.4% of Malaysia's estimated national total, with the remainder corroborated by that same contractor data. Using Johor alone to represent Malaysia in the regional comparison understated the country's actual position: Malaysia's national capacity (an estimated 2,055 MW by end-2026) would exceed Singapore's, once realised, even though Johor specifically does not. This is stated carefully as a forecast, not a settled fact: Malaysia's last confirmed national figure (784MW, 3Q2025) still trails Singapore's current level. Notebook 11 and Notebook 1 were both updated to state this plainly rather than leave the original, narrower framing standing.

## Data Sources

Bank Negara Malaysia, "From Bytes to Bucks: The Economics of Data Centres in Malaysia," Quarterly Bulletin Q3 2025 box article (primary government analysis; BNM's own terms restrict reproduction of its content, see Methodology for how this is handled); TNB analyst briefings and quarterly results, as independently reported by RHB/i3investor, BusinessToday, and moomoo (TNB's own site is not directly reproduced, see Methodology); YTL Power International Berhad FY2026 Annual Interim Report (primary regulatory filing); Keppel Ltd FY2025 results, as independently reported (competitor benchmark, Notebook 5); individual Bursa Malaysia contract announcements and press releases for Sunway Construction Group, Gamuda Berhad, and IJM Corporation, 2024-2026, IJM's own order-book figures cited via independent pickup (Bernama, The Edge, BusinessToday), since IJM's site terms also restrict reproduction; a written Parliamentary answer from the Ministry of Energy Transition and Water Transformation, 6 July 2026, citing JPPPET No 1/2026; EcoWorld, Princeton Digital Group, UEM Sunrise, Sime Darby Property, Mah Sing Group, and Gamuda press releases (land transactions in Johor, Selangor, and Negeri Sembilan); hyperscaler press releases (AWS, Microsoft, Google, Oracle, Nvidia, ByteDance); JLL Malaysia data centre market report (capacity figures, cited as attributed-secondary; JLL's own terms also restrict reproduction, see Methodology); w.media trade publication reporting and The Star/Malay Mail (water constraint figures for Johor, Selangor, and Negeri Sembilan, sourced to Indah Water Konsortium, Air Selangor, Johor and Selangor state government statements); South China Morning Post (Gelang Patah protest, February 2026); Eco-Business, The Star, and TransitionZero analyses citing TNB data (grid-strain figures independent of TNB's own framing). Full inline citations in each notebook's closing "Sources" cell.

## Limitations

Eight research forks (five before the initial build, three more closing specific gaps afterward) verified this project's figures against primary or independently-corroborating sources. Two gaps flagged in earlier drafts were subsequently resolved rather than left standing: **IJM Corporation's order-book figures**, once traced to IJM's own primary press releases, turned out to be a real, consistent growth trend (RM7.6bn to RM12.9bn to RM15.3bn across three dates), not a genuine conflict (Notebook 6); and **the 7% vs. 9.28% data-centre electricity-share figures** (Notebooks 4 and 11) turned out to be the same measurement taken about two months apart, meaning the government's own July 2026 forecast was already outpaced by actual growth, a stronger finding than the original "unreconciled" framing.

Genuine gaps that remain, disclosed explicitly rather than silently: **YTL Power's regional competitor benchmark is real but imperfect** (Keppel Ltd's Connectivity segment is a broader, mixed segment that includes submarine cables alongside data centres, not a pure like-for-like comparison; ST Telemedia has no usable public financials at all since its 2026 privatisation, Notebook 5); **no disbursement-to-date data exists publicly for any hyperscaler pledge**, meaning the true scale of capital actually deployed in Malaysia by any of the six hyperscalers covered cannot currently be measured from public information (Notebook 8); **a widely-repeated Johor land-price trend figure could not be verified** to this project's sourcing standard and was excluded rather than passed through (Notebook 7); **one claim about a multi-year pause in new gas-fired power capacity could not be verified** (a source fetch failed) and was excluded (Notebook 11); **a specific claim about an 18% data centre water-application approval rate across three states could not be traced to a real regulator, report, or date, and was excluded** (Notebook 10); the relationship between a RM1.008 billion Gamuda infrastructure contract at Springhill and Notebook 6's existing Gamuda Port Dickson contracts is unconfirmed, so it is reported separately rather than assumed identical or additional (Notebook 7); and **the per-facility water-use figures are well-corroborated industry estimates, not a single primary engineering study** (Notebook 10). This project also describes an active, evolving policy environment (the informal application moratorium, Johor's water-tier rules, Selangor's approval gate) as of publication; some of these positions may have changed by the time this is read.
